...
# %%
XMFF_trainarray[:, mi_scores > 0.0065].shape
...
# %%
modelKNNreduced = KNeighborsRegressor(n_neighbors=5)
...
# %%
correlation_coefficient, p_valuecc = pearsonr(predictionsxgb, YMFF_test_array)
...
# %%
t_statistic, p_valuet = ttest_rel(absolute_errorsxgb, absolute_errorsrf)
